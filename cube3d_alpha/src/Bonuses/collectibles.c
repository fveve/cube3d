...
/*   Updated: 2024/09/04 16:54:40 by joncurci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void collect_item(t_data *data)
{
    ...
    if (collectible_index != -1 && data->bonus_data->collectibles[collectible_index].is_collected == 0)
    {
		...
		else if (data->bonus_data->collected_count == data->bonus_data->num_collectibles - 1)
			playsound("cub3d_tablet_sound6", 0, 0, 0);
		else if (data->bonus_data->collected_count == data->bonus_data->num_collectibles)
