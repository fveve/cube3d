...
/*   Updated: 2024/09/11 20:38:53 by joncurci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	char current_tile)
{
	...
	if (current_tile == '1')
		...
		if_collec_loop2(data, tex_index2, &collectible_index);
	else if (current_tile == 'Z')
		if_ennemy_loop2(data, tex_index2, &collectible_index);
}
...
void	dda_loop2(t_data *data, int *tex_index2)
{
	...
	while (data->trace_data->hit == 0)
		set_the_hit_loop2(data, tex_index2, collectible_index, current_tile);
}
...
{
	calculate_distance2_part1(data);
