...
/*   Updated: 2024/09/05 15:42:09 by joncurci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_img	*init_img_hd(void *mlx, char *texture, int trigger)
{
	t_img	*data;
	int		h;
	int		w;
	...
	//data->img = (trigger == 0) ? mlx_new_image(mlx, SCREEN_HEIGHT, SCREEN_WIDTH) : mlx_xpm_file_to_image(mlx, texture, &w, &h);
	if (trigger == 0)
		data->img = mlx_new_image(mlx, 1080, 1920);
	else
		data->img = mlx_xpm_file_to_image(mlx, texture, &w, &h);
	data->addr = mlx_get_data_addr(data->img,
			&data->bits_per_pixel,
...
void	init_mlx_data(t_mlx_data *data, char *texture[37])
{
	int	x;
    ...
    /*data->texture[x++] = init_img_hd(data->mlx, TITLE1, 1);
    data->texture[x++] = init_img_hd(data->mlx, TITLE2, 1);
    data->texture[x++] = init_img_hd(data->mlx, TITLE3, 1);
    data->texture[x++] = init_img_hd(data->mlx, TITLE4, 1);
    data->texture[x++] = init_img_hd(data->mlx, TITLE3, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING1, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING2, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING3, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING4, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING5, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING6, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING7, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING8, 1);
    data->texture[x++] = init_img_hd(data->mlx, LOADING9, 1);*/
